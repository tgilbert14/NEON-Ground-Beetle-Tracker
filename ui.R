...
ground_beetle_poster <- function() {
  tags$section(
    class = "gbt-poster",
    `aria-labelledby` = "gbt-poster-title",
    div(class = "gbt-poster-copy",
      div(class = "gbt-poster-topline",
        div(class = "gbt-poster-brand", "Desert Data Labs"),
        tags$nav(class = "gbt-poster-nav", `aria-label` = "NEON Explorer Suite",
          tags$a(class = "gbt-poster-suite-link",
            href = "https://tgilbert14.github.io/NEON-Driver-Cascade/",
            target = "_blank", rel = "noopener",
            "Whole suite: ", tags$strong("Driver Cascade"), tags$span("↗")))),
      div(class = "gbt-poster-app", "NEON Ground Beetle Tracker · unofficial"),
      h1(id = "gbt-poster-title", `aria-label` = "What moves at ground level?",
        tags$span("What moves"), tags$em("at ground level?")),
      p(class = "gbt-poster-promise",
        "Explore the ground beetles NEON pitfall traps encountered, site by site and season by season."),
      tags$a(class = "gbt-poster-cta", href = "#site-picker-start",
      ...
      p(class = "gbt-poster-note",
        "Public NEON DP1.10022.001 · catch per valid trap-night is an activity index—not population density or site health.")),
    tags$figure(class = "gbt-poster-art",
      HTML(paste0(
        '<svg viewBox="0 0 900 900" preserveAspectRatio="xMidYMid slice" role="img" aria-labelledby="gbt-art-title gbt-art-desc">',
        '<title id="gbt-art-title">Ground beetle and pitfall trap illustration</title>',
        '<desc id="gbt-art-desc">A large copper ground beetle crosses a moss-green forest floor above a simple cutaway of a pitfall trap.</desc>',
        '<defs><radialGradient id="gbt-halo" cx="62%" cy="40%" r="48%"><stop offset="0" stop-color="#a8c46e" stop-opacity=".42"/><stop offset="1" stop-color="#a8c46e" stop-opacity="0"/></radialGradient>',
        '<linearGradient id="gbt-elytra" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#f1b083"/><stop offset=".48" stop-color="#dc7f49"/><stop offset="1" stop-color="#8f452b"/></linearGradient>',
        '<linearGradient id="gbt-soil" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#314a35"/><stop offset="1" stop-color="#19241d"/></linearGradient>',
        '<filter id="gbt-shadow" x="-30%" y="-30%" width="160%" height="160%"><feDropShadow dx="0" dy="18" stdDeviation="16" flood-color="#030705" flood-opacity=".5"/></filter></defs>',
        '<rect width="900" height="900" fill="#101914"/><circle class="gbt-halo" cx="590" cy="365" r="350" fill="url(#gbt-halo)"/>',
        '<path d="M0 650C130 610 235 660 352 630c115-29 213-8 300 28 92 38 164 26 248-4v246H0z" fill="url(#gbt-soil)"/><path d="M0 650c134-40 231 8 354-19 121-27 214-5 300 29 88 35 164 25 246-7" fill="none" stroke="#a8c46e" stroke-width="8" stroke-linecap="round"/>',
        '<g opacity=".28" stroke="#a8c46e" stroke-width="4" fill="none"><path d="M75 610c15-45 33-71 57-91M120 614c-8-40-5-75 9-109M195 626c10-40 26-71 48-94M738 636c4-42 18-78 42-108M795 643c-7-38-5-71 6-101"/></g>',
        '<g filter="url(#gbt-shadow)"><path d="M520 656h255l-38 211H557z" fill="#202f25" stroke="#dc7f49" stroke-width="10"/><path d="M507 650h280" stroke="#f1b083" stroke-width="17" stroke-linecap="round"/><path d="M553 704h192M545 755h191M538 807h186" stroke="#a8c46e" stroke-opacity=".3" stroke-width="5"/></g>',
        '<g class="gbt-trail" fill="#f1b083"><circle cx="668" cy="578" r="7"/><circle cx="703" cy="611" r="6"/><circle cx="736" cy="631" r="5"/><circle cx="765" cy="643" r="4"/></g>',
        '<g class="gbt-beetle" filter="url(#gbt-shadow)" transform="translate(565 345) rotate(24)"><g fill="none" stroke="#dc7f49" stroke-width="13" stroke-linecap="round"><path d="M-78-54C-135-91-167-126-174-168M-67-10C-137-23-179-37-209-67M-65 38c-70 22-115 50-142 89M78-54c57-37 89-72 96-114M67-10c70-13 112-27 142-57M65 38c70 22 115 50 142 89"/><path d="M-31-105c-48-61-69-111-62-150M31-105c48-61 69-111 62-150" stroke-width="8"/></g>',
        '<ellipse cx="0" cy="39" rx="105" ry="164" fill="url(#gbt-elytra)" stroke="#f1b083" stroke-width="8"/><path d="M0-116v313" stroke="#783622" stroke-width="7" opacity=".88"/><path d="M-83-62C-40-91 40-91 83-62" fill="#b75e36" stroke="#f1b083" stroke-width="7"/><ellipse cx="0" cy="-123" rx="62" ry="54" fill="#8f452b" stroke="#f1b083" stroke-width="7"/><path d="M-81 10c29 12 53 18 81 18s52-6 81-18M-86 72c30 13 56 19 86 19s56-6 86-19M-70 132c24 10 46 15 70 15s46-5 70-15" fill="none" stroke="#f7c39d" stroke-width="4" opacity=".45"/><circle cx="-25" cy="-138" r="7" fill="#f3e8cb"/><circle cx="25" cy="-138" r="7" fill="#f3e8cb"/></g>',
        '<g fill="#dc7f49" opacity=".7"><circle cx="205" cy="204" r="7"/><circle cx="243" cy="183" r="4"/><circle cx="788" cy="236" r="6"/></g></svg>'
      )),
      tags$figcaption("Code-native editorial illustration—not a field photograph or data record."))
  )
}
...
ui <- bslib::page_fillable(
  ...
  # ---- hero + stats ------------------------------------------------------
  hidden(div(id = "loadedHero", class = "app-hero",
    h2(class = "app-title", "NEON Ground Beetle Tracker",
    ...
    navset_card_tab(id = "tabs",
      ...
      nav_panel(
        ...
        conditionalPanel("output.hasEnv == true",
          card(full_screen = TRUE,
            card_head("calendar-range", "Does beetle activity track its limiting season?",
            ...
            # LEAD with the prior-first seasonal read; the best-of-52 dredge is
            # demoted below it (and dimmed when its permutation isn't significant).
            uiOutput("seasonalDriver"),
            div(id = "envDredgeBlock", class = "env-dredge",
              div(class = "env-dredge-head",
                tags$span(class = "env-dredge-eyebrow", bs_icon("search"),
                  " Exploratory best-of-52 driver search"),
                info_pop("Why this 'best driver' is probably not a real signal",
