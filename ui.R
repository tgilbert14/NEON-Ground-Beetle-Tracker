        ...
        card(full_screen = TRUE,
          card_head("bar-chart-line-fill", "Carabid community — most abundant first",
            info_pop("Community composition",
              ...
              p(tags$b("Activity, not density."), " Pitfall catch \U221D activity \U00D7 density, so fast, large, surface-active hunters (tiger beetles, ", tags$em("Pasimachus"), ") score high regardless of true abundance \U2014 compare like body plans, not a tiger beetle against a litter specialist."))),
          ...
          card(full_screen = TRUE,
            card_head("bar-chart-steps", "Which environmental driver does beetle activity track best?",
              info_pop("Driver comparison",
                ...
                p(tags$b("Reading r:"), " it runs −1…+1 — sign is the direction, size is how tightly they move together. It is ", tags$b("not"), " the % of activity explained (that's r²). Colour encodes the driver's identity; bar side-of-0 encodes the sign."),
