    ...
    tags$figure(class = "gbt-poster-art",
      tags$picture(
        tags$source(
          type = "image/webp",
          srcset = paste(
            "assets/ground-beetle-living-poster-840.webp 840w,",
            "assets/ground-beetle-living-poster.webp 1672w"
          ),
          sizes = "(max-width: 900px) 100vw, 58vw"
        ),
        tags$img(
          src = "assets/ground-beetle-living-poster.png",
          alt = paste(
            "Editorial screenprint of a ground beetle crossing moss and leaf litter",
            "beside a pitfall trap embedded in a forest-floor cutaway."
          ),
